(function() {
  ...
  async function renderPaperTrades() {
    ...
    try {
      ...
      const engC = {NEAR_CERTAIN:'#ccaa00', SHORT_TERM:'#00cc66', LONG_TERM:'#88aaff', ANTI_NC:'#cc44ff', NEWS:'#ff8844'};
      ...
      openSorted.slice(0, 60).forEach(t => {  // cap at 60 cards to stay lightweight
        ...
        signalHtml +=
          ...
          '<div style="color:'+c+';font-size:0.65em;font-weight:700;letter-spacing:0.5px">'+(t.type||'').replace(/_/g,' ')+'</div>'+
